...
// Função que movimenta todos os inimigos de acordo com a direção que é atribuída a cada um em cada rotina do jogo.
int movimenta_inimigos (JOGO *jogo_t, int qt_inimigos) {
    int i, a, b; // a = linhas, b = colunas, i é uma variável auxiliar que indica o inimigo.
    int flag_colisao;
